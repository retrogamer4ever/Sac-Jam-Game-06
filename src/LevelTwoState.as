package
{
	...
	public class LevelTwoState extends FlxState
	{
		...
		override public function create():void
		{
			...
			bottomButton = new FlxSprite( 0, 530, rawButton );
			bottomButton.immovable = true;
			add( bottomButton );
			
			topButton = new FlxSprite( 200, 530, rawButton );
			...
			playerTwo = new FlxSprite( 800, 300, rawPlayerTwo );
